...
class Detector():
   ...
   def __init__(self):
      ...
      rospy.wait_for_message('/bebop/camera_info', CameraInfo)

      # Subscribe to Kinect v2 sd camera_info to get image frame height and width
      rospy.Subscriber('/bebop/camera_info', CameraInfo, self.camera_data, queue_size=1)
   ...
   def image_callback(self, msg):
      ...
      lower_green = numpy.array([0, 200, 121], numpy.uint8)      # fluffy green ball
      upper_green = numpy.array([19, 255, 221], numpy.uint8)
